...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-130646.329195, 5746474.887948, -72587.552008, 5790732.808262], maxZoom: 13, minZoom: 11
    })
});
...
map.getView().fit([-130646.329195, 5746474.887948, -72587.552008, 5790732.808262], map.getSize());
